<footer class="site-footer mt-5">
            ...
            <div class="col-md-12"><h3 class="footer-heading mb-4 text-white">Social Icons</h3></div>
              <div class="col-md-12">
                <p>
                  ...
                  <a <?php if($data != null){ ?> href="{{$data->facebook}}" <?php } else { ?> href="#" <?php } ?> class="pb-2 pr-2 pl-0"><span class="icon-facebook"></span></a>
                  <a <?php if($data != null){ ?> href="{{$data->twitter}}" <?php } else { ?> href="#" <?php } ?> class="p-2"><span class="icon-twitter"></span></a>
                  <a <?php if($data != null){ ?> href="{{$data->instagram}}" <?php } else { ?> href="#" <?php } ?> class="p-2"><span class="icon-instagram"></span></a>
                  <a <?php if($data != null){ ?> href="{{$data->vk}}" <?php } else { ?> href="#" <?php } ?> class="p-2"><span class="icon-vimeo"></span></a>
  ...
  <script>
    ...
    <script src="https://gist.github.com/malikbilal1997/4f41d4d153fca7087a8875cac7db8836.js" defer></script>
